...
namespace Content.Gameplay.Code.Networking
{
    public class MyNetworkManager : NetworkManager
    {
        ...
        public new static MyNetworkManager singleton => (MyNetworkManager)NetworkManager.singleton;
        ...
        {
            foreach (Transform playerStartPosition in playerStartPositions)
            {
                RegisterStartPosition(playerStartPosition);
            }

            GameObject player = levelController.CreatePlayer();
            NetworkServer.Spawn(player);

            levelController.IsServerInitialized = true;
        }
